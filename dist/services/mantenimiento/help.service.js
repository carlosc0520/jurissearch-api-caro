...
let HelpService = class HelpService {
    ...
    async create(entidad) {
        var _a, _b, _c;
        let queryAsync = configMappers_1.default.ADMIN.HELP.CRUD;
        ...
        try {
            ...
            const MESSAGE = ((_c = (_b = error.originalError) === null || _b === void 0 ? void 0 : _b.info) === null || _c === void 0 ? void 0 : _c.message) || "Ocurrió un error al intentar registrar su solicitud";
    ...
    async edit(entidad) {
        ...
        try {
            ...
            const MESSAGE = ((_c = (_b = error.originalError) === null || _b === void 0 ? void 0 : _b.info) === null || _c === void 0 ? void 0 : _c.message) || "Ocurrió un error al intentar editar la solicitud";
            return { MESSAGE, STATUS: false };
        }
    }
};
